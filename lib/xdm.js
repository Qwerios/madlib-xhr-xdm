(function() {
  ...
  (function(factory) {
    if (typeof exports === "object") {
      return module.exports = factory(require("madlib-console"), require("q"), require("madlib-xhr"), require("madlib-shim-easyxdm"), require("madlib-hostmapping"));
    } else if (typeof define === "function" && define.amd) {
      return define(["madlib-console", "q", "madlib-xhr", "madlib-shim-easyxdm", "madlib-hostmapping"], factory);
    }
  })(function(console, Q, XHR, easyXDMShim, HostMapping) {
    var XDM, xdmChannelPool;
    xdmChannelPool = [];
    return XDM = (function(_super) {
      ...
      function XDM(settings) {
        ...
        this.hostMapping = new HostMapping(this.settings);
      }
      ...
      XDM.prototype.createXDMChannel = function(url, callback) {
        var hostBaseUrl, hostName, options, remote, rpcChannel, swfUrl;
        ...
        options = {
          remote: this.xdmSettings.xdmProvider,
          swf: swfUrl,
          onReady: callback
        };
        rpcChannel = {
      ...
      XDM.prototype.open = function(method, url, user, password) {
        this.xdmSettings = hostMapping.getXdmSettings(url) || {};
        if (this.xdmSettings == null) {
          ...
          if (this.xdmSettings.cors && ((new XMLHttpRequest())["withCredentials"] != null)) {
            ...
            this.transport = null;
            this.xdmChannel = this.createXDMChannel(url);
            this.request = {
              headers: {},
              url: url,
              method: method,
      ...
      XDM.prototype.send = function(data) {
        ...
        if (!this.isXDMCall()) {
          ...
          if (this.xdmSettings.xdmVersion < 3) {
            parameters.dataType = this.request.type;
