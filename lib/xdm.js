(function() {
  ...
  (function(factory) {
    ...
    return XDM = (function(_super) {
      ...
      XDM.prototype.open = function(method, url, async, username, password) {
        this.xdmSettings = this.hostMapping.getXdmSettings(url);
        async = true;
        if ((this.xdmSettings == null) || this.isSameOrigin(url)) {
          return XDM.__super__.open.call(this, method, url, async, username, password);
        } else {
      ...
      XDM.prototype.send = function(data) {
        ...
        if (this.transport) {
          ...
          window.xdmChannelQueue.ready().then((function(_this) {
            return function() {
              var xhrError;
              if (_this.timeout !== 0) {
      ...
      XDM.prototype.isSameOrigin = function(url) {
        var aLink, isSameOrigin, location;
        isSameOrigin = true;
        if ((typeof window !== "undefined" && window !== null) && (typeof document !== "undefined" && document !== null)) {
          location = window.location;
          aLink = document.createElement("a");
          aLink.href = url;
          return isSameOrigin = aLink.hostname === location.hostname && aLink.port === location.port && aLink.protocol === location.protocol;
        }
      };
      ...
      XDM.prototype.createSuccessResponse = function(xhrResponse) {
        ...
        } else if (this.xdmSettings.cors && ((new XMLHttpRequest())["withCredentials"] != null)) {
          return XDM.__super__.createSuccessResponse.call(this, xhrResponse);
        } else {
